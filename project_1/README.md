...
Welcome to the application where you can navigate as a patient or a physician!
Please be in the correct directory and type: "ruby bin/run.rb" and hit enter to start the application!
The instructions will be displayed on the commandline and is very easy to follow!

Thank you for your time and enjoy!# cli-project
